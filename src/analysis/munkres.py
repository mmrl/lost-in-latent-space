...
# This code was taken from the github repository code for the article
# "Towards Nonlinear Disentanglement in Natural Data with Temporal
# Sparse Coding" (https://github.com/bethgelab/slow_disentanglement/).
# The original code can be found in Marioka et al, 2018.
...
possible to us a rectangular matrix if you first pad it with 0 values to make
...
if __name__ == '__main__':
    ...
    for cost_matrix, expected_total in matrices:
        ...
        assert expected_total == total_coste
